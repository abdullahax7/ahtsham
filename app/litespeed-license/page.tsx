...
const FALLBACK_HERO_TITLE = 'LiteSpeed Web Server License';
const FALLBACK_HERO_SUBTITLE = 'LiteSpeed is a high-performance, high-scalability web server designed to handle high-traffic websites efficiently while offering superior built-in caching and security.';
...
export default function LitespeedLicense() {
  ...
  useEffect(() => {
    let alive = true;
    fetch('/api/public/product/litespeed-license')
