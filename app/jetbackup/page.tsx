...
const plans = [
  {
    ...
    popular: true,
    orderLink: 'https://qazi.host/cart.php?a=add&pid=34',
    specs: [
...
export default function JetbackupLicense() {
  return (
    <main>
      ...
      <ProductSchema 
        name="JetBackup Enterprise License" 
        url="https://qazi.host/jetbackup" 
        currency="PKR"
        plans={plans} 
      />
      ...
      <PremiumGuarantees />
      <RelatedBlogs productSlug="jetbackup" title="Related Guides for JetBackup" />
      <Footer />
    </main>
  );
}
