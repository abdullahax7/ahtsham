      ...
      <section className="page-hero blur-in visible">
        ...
        <div className="page-hero-content page-hero-content--split">
          <div className="hero-text">
            <h1 className="delay-1">SitePad Website Builder License</h1>
            <p className="delay-2">SitePad is a drag-and-drop website builder that integrates with hosting panels, offering hundreds of professional themes and a simple interface for creating beautiful websites without coding.</p>
          </div>
