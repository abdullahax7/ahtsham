...
const FALLBACK_PLANS: Plan[] = [
  {
    ...
    popular: true,
    orderLink: 'https://qazi.host/cart.php?a=add&pid=37',
    specs: [
...
const FALLBACK_HERO_TITLE = 'SitePad Website Builder License';
const FALLBACK_HERO_SUBTITLE = 'SitePad is a drag-and-drop website builder that integrates with hosting panels, offering hundreds of professional themes and a simple interface for creating beautiful websites without coding.';

export default function SitepadLicense() {
  ...
  useEffect(() => {
    let alive = true;
    fetch('/api/public/product/sitepad')
  ...
  return (
    <main>
      ...
      <ProductSchema
        name="SitePad Website Builder License"
        url="https://qazi.host/sitepad"
        currency="PKR"
        plans={plans}
      />
      ...
      <section className="page-hero blur-in visible">
        <HeroParticles glowColor="rgba(244, 63, 94, 0.4)" />
        <div className="page-hero-content page-hero-content--split">
          ...
          <div className="hero-logo-side">
            <LicenseLogo type="sitepad" glowColor="rgba(244, 63, 94, 0.4)" />
          </div>
        </div>

      </section>

      <SetupGuide type="sitepad" />
      ...
      <PremiumGuarantees />
      <RelatedBlogs productSlug="sitepad" title="Related Guides for SitePad" />
      <Footer />
    </main>
  );
}
