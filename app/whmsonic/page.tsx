      ...
      <section className="page-hero blur-in visible">
        ...
        <div className="page-hero-content page-hero-content--split">
          <div className="hero-text">
            <h1 className="delay-1">WHMSonic Shoutcast License</h1>
            <p className="delay-2">WHMSonic is a popular WHM/cPanel plugin that enables hosting providers to offer Shoutcast streaming and AutoDJ hosting services to their clients with ease.</p>
          </div>
