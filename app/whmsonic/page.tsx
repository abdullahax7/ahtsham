...
const FALLBACK_PLANS: Plan[] = [
  {
    ...
    popular: true,
    orderLink: 'https://qazi.host/cart.php?a=add&pid=41',
    specs: [
...
const FALLBACK_HERO_TITLE = 'WHMSonic Shoutcast License';
const FALLBACK_HERO_SUBTITLE = 'WHMSonic is a popular WHM/cPanel plugin that enables hosting providers to offer Shoutcast streaming and AutoDJ hosting services to their clients with ease.';

export default function WhmsonicLicense() {
  ...
  useEffect(() => {
    let alive = true;
    fetch('/api/public/product/whmsonic')
  ...
  return (
    <main>
      ...
      <ProductSchema
        name="WHMSonic Shoutcast License"
        url="https://qazi.host/whmsonic"
        currency="PKR"
        plans={plans}
      />
      ...
      <section className="page-hero blur-in visible">
        <HeroParticles glowColor="rgba(239, 68, 68, 0.4)" />
        <div className="page-hero-content page-hero-content--split">
          ...
          <div className="hero-logo-side">
            <LicenseLogo type="whmsonic" glowColor="rgba(239, 68, 68, 0.4)" />
          </div>
        </div>

      </section>

      <SetupGuide type="whmsonic" />
      ...
      <PremiumGuarantees />
      <RelatedBlogs productSlug="whmsonic" title="Related Guides for WHMSonic" />
      <Footer />
    </main>
  );
}
