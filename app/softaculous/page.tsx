      ...
      <section className="page-hero blur-in visible">
        ...
        <div className="page-hero-content page-hero-content--split">
          <div className="hero-text">
            <h1 className="delay-1">Softaculous Auto-Installer License</h1>
            <p className="delay-2">Softaculous is a leading auto-installer that allows web hosting users to install over 400 scripts and applications, including WordPress and Joomla, with just a single click.</p>
          </div>
