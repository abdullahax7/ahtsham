...
const FALLBACK_PLANS: Plan[] = [
  {
    ...
    popular: true,
    orderLink: 'https://qazi.host/cart.php?a=add&pid=36',
    specs: [
...
const FALLBACK_HERO_TITLE = 'Softaculous Auto-Installer License';
const FALLBACK_HERO_SUBTITLE = 'Softaculous is a leading auto-installer that allows web hosting users to install over 400 scripts and applications, including WordPress and Joomla, with just a single click.';

export default function SoftaculousLicense() {
  ...
  useEffect(() => {
    let alive = true;
    fetch('/api/public/product/softaculous')
  ...
  return (
    <main>
      ...
      <ProductSchema
        name="Softaculous Auto-Installer License"
        url="https://qazi.host/softaculous"
        currency="PKR"
        plans={plans}
      />
      ...
      <section className="page-hero blur-in visible">
        <HeroParticles glowColor="rgba(236, 72, 153, 0.4)" />
        <div className="page-hero-content page-hero-content--split">
          ...
          <div className="hero-logo-side">
            <LicenseLogo type="softaculous" glowColor="rgba(236, 72, 153, 0.4)" />
          </div>
        </div>

      </section>

      <SetupGuide type="softaculous" />
      ...
      <PremiumGuarantees />
      <RelatedBlogs productSlug="softaculous" title="Related Guides for Softaculous" />
      <Footer />
    </main>
  );
}
