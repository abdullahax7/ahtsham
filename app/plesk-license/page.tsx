      ...
      <section className="page-hero blur-in visible">
        ...
        <div className="page-hero-content page-hero-content--split">
          <div className="hero-text">
            <h1 className="delay-1">Plesk Panel License</h1>
            <p className="delay-2">Plesk is a multi-faceted hosting platform that simplifies server administration by automating tasks and providing robust security features for developers and sysadmins.</p>
          </div>
