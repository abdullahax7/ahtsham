      ...
      <section className="page-hero blur-in visible">
        ...
        <div className="page-hero-content page-hero-content--split">
          <div className="hero-text">
            <h1 className="delay-1">Virtualizor VPS Panel License</h1>
            <p className="delay-2">Virtualizor is a powerful web-based VPS control panel that allows server administrators to create and manage virtual private servers across multiple virtualization technologies like KVM, Xen, and OpenVZ.</p>
          </div>
